...
const QuizShow = ({ gradeLevel, activity }) => {
      ...
      <div className="md:pl-14 lg:pl-14 md:pr-14 lg:pr-14">
        ...
        >
          <div className="carousel-wrapper">
            <div className="carousel-progress">
              {showProgress && (
                <div className="flex mx-auto w-full mb-5 flex-wrap md:flex-nowrap">
                  <div className="flex font-semibold w-80 sm:w-48 lg:w-48 justify-around">
                    <p className="mr-1">
                      {activity?.subjectName?.toUpperCase().includes("ARALING")
                        ? "Tanong"
                        : "Question"}
            ...
            >
              {activity.activity &&
                activity.activity.map((qs, index) => (
                  <div key={qs.questionId} className="p-2">
                      ...
                      <div className="p-5 w-full">
                        <div className="relative">
                          ...
                          <div className="p-10 py-5">
                            <p className="text-center tsext-lg sm:text-2xl break-words p-5">
                              {qs?.question !== "" &&
                    ...
                    {Array.isArray(qs.choices) ? (
                      <>
                        <p className="font-bold text-[#363636] tracking-tight py-8 pb-4">
                        ...
                        <div className="text-center text-base sm:text-2xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                          {qs.choices.map((qss, index) => {
                            const pattern =
                              /(?<=\S)([^\w\s]|[\uD800-\uDBFF][\uDC00-\uDFFF])(?=\S)/gu;
                            const outputString = qss?.description?.replace(
                              pattern,
                              " $1 "
                            );
                            return (
                              ...
                              >
                                ...
                                <div
                                  className={`flex cursor-pointer justify-center shadow-lg items-center p-5 w-full min-h-[85px] h-full rounded-lg ${
                                    isPrimary && qss.isCorrect === 1
                                      ? "bg-[#87ff7c]"
                                      : clickedIndex === index
