      ...
      <div className="md:pl-14 lg:pl-14 md:pr-14 lg:pr-14">
        ...
        >
          <div className="carousel-wrapper">
            ...
            >
              {activity.activity &&
                activity.activity.map((s, index) => (
                  <div key={s.questionId} className="p-2">
                    <div className="bg-white border-b-8 border-gray-300 rounded-md w-full flex flex-col items-center justify-center place-content-between shadow-lg">
                      <div className="sm:p-5 w-full">
                        <div className="relative">
                          ...
                          <div className="sm:p-10 py-5">
                            <p className="text-center text-lg sm:text-2xl break-words p-5">
                              {s?.question !== "" &&
                                s?.question !== "undefined" &&
                                s?.question !== undefined && (
                                  <div className="text-center text-lg sm:text-2xl break-words p-2 sm:p-5">
                                    {s.question}
                                  </div>
                                )}
                            </p>
                    ...
                    {Array.isArray(s.choices) ? (
                      <>
                        <p className="font-bold text-[#363636] tracking-tight py-5 pb-2">
                        ...
                        <div className="text-center text-base sm:text-2xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                          {/* choices dapat, for testing change to choice */}
                          {s.choices.map((saw, index) => {
                            const pattern =
                              /(?<=\S)([^\w\s]|[\uD800-\uDBFF][\uDC00-\uDFFF])(?=\S)/gu;
                            const outputString = saw?.description?.replace(
                              pattern,
                              " $1 "
                            );
                            return (
                              ...
                              >
                                ...
                                <div
                                  className={`flex justify-center items-center cursor-pointer p-5 w-full min-h-[85px] h-full rounded-lg ${
                                    isPrimary && saw.isCorrect === 1
                                      ? "bg-[#87ff7c]"
                                      : clickedIndex === index
