            ...
            >
              {activity.activity &&
                activity.activity.map((otbq, index) => (
                  <div key={otbq.questionId} className="p-2 ">
                    ...
                    {Array.isArray(otbq.choices) ? (
                      <div className="w-full p-5 my-0">
                        ...
                        <div className="text-center sm:text-2xl text-base grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 my-5 gap-6 ">
                          {otbq.choices.map((otba, index) => {
                            const pattern =
                              /(?<=\S)([^\w\s]|[\uD800-\uDBFF][\uDC00-\uDFFF])(?=\S)/gu;
                            const outputString = otba?.description?.replace(
                              pattern,
                              " $1 "
                            );
                            return (
            ...
            {currentSlide !== slideCount && (
              <div className="flex justify-center p-5 sm:pl-20 sm:pr-20">
                <div
                  ...
                  onClick={handleClick}
                >
                  <div className="flip-card-inner w-36 h-20 sm:w-56 sm:h-20 cursor-pointer rounded-xl border-4 border-white ">
